...
On the other hand, Linux makes no distinction and instead maintains a sole \textit{root}, \texttt{/}, where everything is seen as a 'file', such as a hard disk (\texttt{/dev/sda}), or a media file you may have (\texttt{/home/user/swedgefulBasslines.mp3}). % Fucking cretin
