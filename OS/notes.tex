...
>>>>>>> ceae001a7f46fa7d0bb64045fdf1cfc94997b3c3
\filbreak
...
=======
This could mean that there is not enough memory or that the memory is over-commited
...
There are a few types of access methods
\begin{itemize}
    \item Sequential Access - read byte by byte
    \item Direct Access - random access given to block/byte
    \item Record Access - file is array of records
    \item Indexed Access - one file contains an index of a record in another file
\end{itemize}
%NOT FINISHED THIS PLEASE FEEL FREE TO FINISH LECTURE 13
