...
\begin{framed}
  ...
  \begin{itemize}
  \item \textbf{Sequential Access} - read byte by byte
  \item \textbf{Direct Access} - random access given to block/byte
  \item \textbf{Record Access} - file is array of records
  \item \textbf{Indexed Access} - one file contains an index of a record in another file
  \end{itemize}
\end{framed}
