...
\item[PTBR] Page Table Base Register - holds the physical addres of the start of the page table
...
This quicky gets silly. A page number in a three level paging system for a 64 bit address space is as follows:
